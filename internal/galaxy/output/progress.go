...
// Printf is transient progress, PersistentPrintf/Okf/OkVersionf/Errorf/
// ErrorVersionf/Warnf are results that always emit, and Debugf/DebugSincef
// appear only in verbose mode. internal/progress holds the implementation;
